...
// IronChestOverlay (image, texture and storage) built from his parent class MachineOverlay which is an inherited class OverlayBase
public class IronChestOverlay extends MachineOverlay{

    // height and width of the overlay (after resizing it)
    private static int w = 480, h = 219;
    ...
    public static Point anchor = new Point(91, 570);
    ...
    static {
        bg = new Texture(Automata.TEXTURE_PATH + "overlay/iron_chest_overlay.png", w, h);
    ...
    // constructor
    public IronChestOverlay(GameScene main, Storage storage) {
        // call constructor from inherited class
        super(main, "IronChestOverlay", storage, w, h);
